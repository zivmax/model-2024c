...
通过 Python 的 PyKrige 软件包，我们可以直接调用其函数进行三维 Kriging 插值的计算。
我们将孔隙度和含水合物饱和度的数据输入到 Kriging 插值模型中，得到了相应的插值结果。
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/task3/task3-1.png}
  \caption{资源量的概率分布图}
\end{figure}
