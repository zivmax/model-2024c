...
%????
\begin{figure}[h!t]
  \centerline{\includegraphics[scale=1]{task1-1.png}}
  \caption{\song\wuhao  天然气水合物资源的三维深度和资源量总分布}
\end{figure}

\begin{figure}[h!t]
  \centerline{\includegraphics[scale=1]{task1-2.png}}
  \caption{\song\wuhao 各井口内资源深度与资源量对应关系}
\end{figure}

\begin{figure}[h!t]
  \centerline{\includegraphics[scale=1]{task1-3.png}}
...
\begin{thebibliography}{99}
  ...
  \bibitem{9}张利彪, 周春光, 马铭, 等. 基于粒子群算法求解多目标优化问题[J]. 计算机研究与发展, 2004, 41(7): 1286-1291.
